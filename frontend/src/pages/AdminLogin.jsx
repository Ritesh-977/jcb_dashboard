...
export default function AdminLogin() {
  ...
  if (auth?.role === 'admin') return <Navigate to="/admin/users" replace />;
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <a href="/login" style={styles.link}>← Back to Dashboard Login</a>
      </div>
    </div>
  );
}
...
const styles = {
  ...
  link: { color: '#666', fontSize: '0.85rem', textDecoration: 'none' },
};
